...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "GoogolplexCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"GoogolplexCoin.org", "dnsseed.GoogolplexCoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"GoogolplexCoin.org", "testnet-seed.GoogolplexCoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GoogolplexCoin is probably already running."), addrBind.ToString().c_str());
        else
